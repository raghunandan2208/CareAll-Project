...
class User:
    ...
    def user_registration(self):
        ...
        if self.role=="younger":
            ...
            mycursor.execute(sql, val)
            mydb.commit()
            # Creating bank account to younger
            sql = "INSERT INTO younger_money (FK_younger_id,balance) VALUES ({},{})".format(val[0],0)
    ...
    def get_user_id(self):
        sql = "SELECT PK_user_id FROM users WHERE email = '{}'".format(self.email)
        mycursor.execute(sql)
